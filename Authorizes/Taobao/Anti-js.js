	...
	function(t) {
		...
		var z, A, M, T = Math.floor(Math.random()*1000), // 修改  默认为0
			L = Math.floor(Math.random()*1000),  // 修改  默认为0
			C = Math.floor(Math.random()*500),									// 修改  默认为0
			E = Math.floor(Math.random()*600),
	...
	var f, m = function() {
			...
			return n.prototype.J = function() {
				for (var n, t = document.cookie, o = []; n = this.G.exec(t);) o.push(n[1]);
				return o
				...
				os_isg = this.H + n + this.I //修改
			}, n.prototype.P = function() {
				var n = this.O;
				this.Q("Thu, 01 Jan 1970 00:00:00 GMT"), this.L(""), this.Q(n)
	...
	function(n) {
		function t() {
            ...
            // return 0
			return Math.floor(Math.random()*(o.length +1 )) //修改
		}
	...
	function(t) {
		...
		function i(t) {
			...
			e[1] = n.a(), e[5] = u.C(), e[6] = d.ga(), e[8] = n.c(navigator.userAgent);
			try {
				u.F(function(n) {
					e[7] = n
				})
		...
		function r(t, i) {
			0 == e[4] && (e[4] = n.a(), e[3] = o()), e[2] = o(), e[16] = u.B(), e[9] = c.k(), e[10] = c.l(), e[11] = c.m(), e[12] = c.n(), e[17] = c.A(), e[18] = c.y();
			var r = c.r();
			e[13] = r.o, e[14] = r.p;
			var f = c.t(),
				m = c.v(),
				s = c.u(),
				l = [i, c.s(), t, f, r.q, history.length > 1, s, m];
			t && a++, e[15] = n.h(l), e[0] = a;
			var v = e.ca();
			return h.ea(v)
		}
	...
	function(t) {
		...
		function g() {
			...
			y.Q(t), y.S("/");
			var i = y.J();
			i.length > 1 && (s.X("exist_multi_isg"), d());
			var r = i[0];
			p.j(r), r = p.ha(!1, null), e(r), 0 === i.length && v(r), n.i(window, "unload", function(n) {
				var t = p.ha(!1, !0);
				y.L(t)
			})
		}
